...
Timecard_FPGA_Stress_Test
    timecard_lib.fpga_stress_test

Timecar_I2C_Stress_Test
    timecard_lib.i2c_stress_test
...
Timecard_Disciplining
    timecard_lib.disciplining           10800
...
Sentinel_Start
    ...
    lib.sync_group                      Sentinel_Start      600

Holdover_Test
    timecard_lib.holdover               86400
    lib.sync_group                      Holdover_Test       3600

Sentinel_Stop
    timecard_lib.stop_sentinel
    lib.sync_group                      Sentinel_Stop       600
...
Timecard_MAC_Verify
    timecard_lib.get_data_sentinel      clock=MAC           plus_minus=1e-6         timeout=3600
